...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ozcanzaferayan/sample-pod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ozcanzaferayan' => 'ozcanzaferayan@gmail.com' }
  s.source           = { :git => 'https://github.com/ozcanzaferayan/sample-pod.git', :tag => s.version.to_s }
  ...
  s.vendored_frameworks = 'SamplePod/Frameworks/FBAudienceNetwork.xcframework'
